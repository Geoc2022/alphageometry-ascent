"""
This file is sourced from EdStem, with minor modifications on our end.
"""
        ...
        if cmd.get("name") == "Circle":
            ...
            if len(in_labels) == 3:  # Circle defined by 3 points
                ...
                if center_label in points_dict and point_label in points_dict:
                    ...
                    circle_data = circle_from_center_and_point(
...
def rename_circle_dictionary(
    ...
    """
    renamed_circles = {}
    for idx, (_, value) in enumerate(circles.items(), start=1):
...
def parse_picture(filename: str):
    ...
    ggb_path = os.path.join(script_dir, filename)
